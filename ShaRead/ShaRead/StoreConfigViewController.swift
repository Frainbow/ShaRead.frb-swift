    ...
    override func viewDidLoad() {
        ...
        if stores.count != 0 {
            ...
            if let url = stores[0].image {
                storeImageView.sd_setImageWithURL(url, placeholderImage: ShaDefault.defaultBanner)
            }
                ...
                instance.uploadAdminStoreImage(
                    ...
                    success: { url in
                        dispatch_async(dispatch_get_main_queue(), {
                            HUD.hide()
                            store.image = url
                            self.storeImageView.sd_setImageWithURL(url, placeholderImage: ShaDefault.defaultBanner)
